    ...
    <div>
      ...
      {status === 'indexed' && (
        <div style={styles.statusList}>
          <div style={styles.statusItem}><span style={styles.check}>✓</span> Uploaded</div>
          <div style={styles.statusItem}><span style={styles.check}>✓</span> Text extracted</div>
          <div style={styles.statusItem}><span style={styles.check}>✓</span> Indexed</div>
        </div>
      )}
    </div>
  );
